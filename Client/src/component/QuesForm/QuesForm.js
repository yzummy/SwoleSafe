...
class QuesForm extends React.Component {
    ...
    handleSubmit(e) {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                const formSubmit = this.postForm(values.username, values.password, values.selectMultiple, values.level)
    ...
    postForm(user, password, bodyparts, level) {
        try {
            return axios.post('http://35.184.165.218/users/', {
                "username": user,
                "password": password,
                "bodypart": bodyparts,
                "level": level
    ...
    render() {
        ...
        return (
            ...
            <Row>
                    ...
                    <Col span={10}><Form.Item label="Password" className="flexCon">
            ...
            <Form.Item label="Gender" className="flexCon">
                ...
                <Row>
                    <Col span={10}><Form.Item label="Height" className="flexCon">
                    {getFieldDecorator('height', {

                    })(
                        <div>
                            <Input prefix={<Icon type="height" style={{ color: 'rgba(0,0,0,.25)' }} />} placeholder="Height" />
                            {/* ft */}
                        </div>
                    )}
                </Form.Item></Col>
                ...
                <Form.Item label="Weight" className="flexCon">
                    {getFieldDecorator('weight', {
                        ...
                        <div>
                            <Input prefix={<Icon type="weight" style={{ color: 'rgba(0,0,0,.25)' }} />} placeholder="Weight" />
                            {/* <span> lbs</span> */}
                        </div>
                    )}
                </Form.Item></Col>
                ...
                <Form.Item label="Level" className="flexCon">
                    {getFieldDecorator("level", {
                        ...
                        <Select defaultValue="beginner" style={{ width: 120 }} onChange={this.handleLevelChange}>
                ...
                <Form.Item
                    label="Bodypart" className="flexCon"
                >
                    {getFieldDecorator('selectMultiple', {
                    })(
                        <Select mode="multiple" placeholder="Please select body part you want to work on">
